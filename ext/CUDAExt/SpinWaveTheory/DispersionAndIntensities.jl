...
function Sunny.intensities_bands(swt::SpinWaveTheoryDevice, qpts; kT=0, with_negative=false)
    ...
    domain = NVTX.Domain("intensities_bands")
    NVTX.name_category(domain, 3, "eigensolver")
    eig_range = NVTX.range_start(domain; message="eigensolver", color=colorant"blue")
